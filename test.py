...
def make_app():
    ...
    app.router.add_route(
        "GET", "/form_with_check", handler_get_form_with_token,
    )
    app.router.add_route(
        "POST", "/post_with_check", handler_post_check,
    )

    app.router.add_route(
        "GET", "/form_without_check", handler_get_form_without_token,
    )
    app.router.add_route(
        "POST", "/post_without_check", handler_post_not_check,
    )
